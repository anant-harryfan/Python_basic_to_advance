...
# Images
imgBalloon = pygame.image.load('./0.Resources_GameDev/BalloonRed.png').convert_alpha()
...
while start:
    ...
    if timeRemain < 0:
        ...
        font = pygame.font.Font(
            '0.Resources_GameDev/Marcellus-Regular.ttf', 50)
        ...
        font = pygame.font.Font(
            '../../../../../Python_Project_By_Me/AI_Karate_Trainer/Resources_Karate/Marcellus-Regular.ttf', 50)
