...
# Images
imgBackground = pygame.image.load('./0.Resources_GameDev/Project - GUI/background.png').convert()
imgDesign = pygame.image.load('./0.Resources_GameDev/Project - GUI/design.png').convert_alpha()
imgIcon1 = pygame.image.load('./0.Resources_GameDev/Project - GUI/icon1.png').convert_alpha()
imgIcon2 = pygame.image.load('./0.Resources_GameDev/Project - GUI/icon2.png').convert_alpha()
imgIcon3 = pygame.image.load('./0.Resources_GameDev/Project - GUI/icon3.png').convert_alpha()
imgIcon4 = pygame.image.load('./0.Resources_GameDev/Project - GUI/icon4.png').convert_alpha()
imgIcon5 = pygame.image.load('./0.Resources_GameDev/Project - GUI/icon5.png').convert_alpha()
imgShadow = pygame.image.load('./0.Resources_GameDev/Project - GUI/shadow.png').convert_alpha()
imgToggleOn = pygame.image.load('./0.Resources_GameDev/Project - GUI/toggleOn.png').convert_alpha()
imgToggleOff = pygame.image.load('./0.Resources_GameDev/Project - GUI/toggleOff.png').convert_alpha()
...
def drawWindowPad(pos, color, text, icon):
    ...
    font = pygame.font.Font(
        '../../../../../Python_Project_By_Me/AI_Karate_Trainer/Resources_Karate/Marcellus-Regular.ttf', 20)
...
def drawFilterPad():
    ...
    # Sliders
    font = pygame.font.Font(
        '../../../../../Python_Project_By_Me/AI_Karate_Trainer/Resources_Karate/Marcellus-Regular.ttf', 25)
    for y in range(0, 3):
        h = 447 + y * 55
